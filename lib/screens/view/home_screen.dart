            ...
            child: CupertinoButton(
              ...
              onPressed: () async {
                ...
                for (int i = 0; i < data.length; i++) {
                  subTotal += bill.productList![i].price! *
                      bill.productList![i].quantity!;
                }
                          ...
                          pd.Expanded(
                            child: pd.Column(
                              ...
                              children: [
                                pd.Text('Bill To:'),
                                pd.Text('Zimil Patel'),
                                pd.Text('303- B, sundaram, shiddhi Vianayk'),
                              ],
                            ),
                          ),
                        ...
                        children: [
                          pd.Expanded(
                            child: pd.Column(
                              children: [
                                titleBox('Product Id '),
                                ...List.generate(bill.productList!.length,
                                    (index) => cellBox(index, '${index + 1}')),
                              ],
                            ),
                          ),
                          pd.Expanded(
                            child: pd.Column(
                              ...
                              children: [
                                ...
                                ...List.generate(
                                    bill.productList!.length,
                                    (index) => cellBox(index,
                                        '${bill.productList![index].name}')),
                              ],
                            ),
                          ),
                          pd.Expanded(
                            child: pd.Column(
                              ...
                              children: [
                                ...
                                ...List.generate(
                                    bill.productList!.length,
                                    (index) => cellBox(index,
                                        '${bill.productList![index].quantity}')),
                              ],
                            ),
                          ),
                          pd.Expanded(
                            child: pd.Column(
                              ...
                              children: [
                                ...
                                ...List.generate(
                                    bill.productList!.length,
                                    (index) => cellBox(index,
                                        '${bill.productList![index].price! * bill.productList![index].quantity!}')),
                              ],
                            ),
                          ),
                        ],
